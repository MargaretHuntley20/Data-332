...
## Expand.grid
rolls
rolls$vlaue <- roll$Var1 + rolls$Var2
head(rolls, 3)
...
head(combos, 3)
sum(combos$prob)
symbols <_ c(combos[combos[1, 1], combos[1, 2], combos[1,3]])
score(symbols)
## 0 
...
# [1] "for"
# [1] "loop"
for (i in c("My", "second", "for", "loop")) { print(i)
}
# [1] "My"
# [1] "second"
# [1] "for"
# [1] "loop"
for (value in c("My", "third", "for", "loop")) { value
}
...
if (diamonds == 3) { prize <- 100
  ...
  payouts <- c("7" = 80, "BBB" = 40, "BB" = 25,
               "B"=10,"C"=10,"0"=0) prize <- unname(payouts[slots[1]])
